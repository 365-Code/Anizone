...
export async function GET(req: NextRequest) {
  try {
    ...
    const query = searchParams.get("query") != ("All") ? searchParams.get("query") || undefined : undefined;
    const type = searchParams.get("type") != ("All") ? searchParams.get("type") || undefined : undefined;
    const status = searchParams.get("status") != ("All") ? searchParams.get("status") || undefined : undefined;
    const season = searchParams.get("season") != ("All") ? searchParams.get("season") || undefined : undefined;
